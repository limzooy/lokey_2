...
export const posts: Post[] = [
  {
    ...
    excerpt: '20대가 저도수 술을 마신다는 말은 사실일까. 국세통계연보 21년치를 직접 열어봤다.',
    ...
    sections: [
      ...
      {
        heading: '5. 그래서 무엇이 달라졌나',
        body:
          "저도수화는 '다른 술로 갈아탄 것'이 아니라 '같은 술이 순해진 것'이었다. " +
          '소비자가 매대에서 새로운 카테고리를 고른 게 아니라, 늘 마시던 술의 도수가 조용히 내려왔다. ' +
          '새 카테고리를 만드는 것보다 기존 카테고리의 도수를 낮추는 쪽이 시장에서 통했다는 뜻이기도 하다. ' +
          '하드셀처와 논알코올이 화제가 되는 동안, 실제로 한국인의 음주를 바꾼 건 소주병에 적힌 숫자였다.',
      },
      {
        heading: '이 분석의 한계',
        body:
